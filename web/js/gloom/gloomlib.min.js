...
(function(){var d=function(a,b){var c,g;this.fretnote=b;this.model=Snap(a);this.note_elm=[];for(g=c=1;6>=c;g=++c)this.note_elm[g]=[]};d.prototype.init=function(a){var b=this;Snap.load("https://cdn.jsdelivr.net/gh/ramanduh/gloom@master/web/img/fretboard.svg",function(c){var a,f,d,h;for(h=a=1;6>=a;h=++a){var e=f=0;for(d=b.fretnote.nb_frets;0<=d?f<=d:f>=d;e=0<=d?++f:--f){var l="#f"+h+"-"+e;b.note_elm[h][e]=c.select(l)}}return b.model.append(c)});return"function"===typeof a?a():void 0};d.prototype.press=function(a){var b=a.string;a=a.fret;this.note_elm[b][a].attr({stroke:"#000",
